...
With every agent step, AgenGit takes a snapshot of your workspace so it knows exactly what files changed. But taking a snapshot of _everything_ is a recipe for slowness and accidentally capturing things you'd rather keep private.
